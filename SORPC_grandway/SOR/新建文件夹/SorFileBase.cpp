...
BOOL CSorFileBase::setReturnData(SORDATA& sorData)
{
	//数据点处理
	...
	sorData.Length = numEachTime * m_fixedParas.vDataPointsEach[0];//每点距离 * 点数//wcq2011.11.25
	//折射率 两点间距离
	...
	//脉宽
	sorData.PulseWidth = m_fixedParas.vPulseWidth[0];
	//采样频率
	sorData.Frequency = 100000000.0 / (m_fixedParas.vDataSpacing[0] * 2);//wcq2012.06.12
